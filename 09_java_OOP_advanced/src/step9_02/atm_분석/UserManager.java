package step9_02.atm_분석;

import java.util.Scanner;

public class UserManager { // 유저관리자 
	
	private UserManager() {} // 계정관리자 
	static private UserManager instance = new UserManager();// private 기본생성자 
	static public UserManager getInstance() { // instance를 반환할 getter를 만들어준다 
		return instance; 
	}
	...
	boolean getCheckAcc(String account) { // 계좌확인 
